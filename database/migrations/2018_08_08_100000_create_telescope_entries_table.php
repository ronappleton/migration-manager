...
return new class extends Migration
{
    ...
    {
        $this->schema->create(
            'telescope_entries', static function (Blueprint $table): void {
        ...
        $this->schema->create(
            'telescope_entries_tags', static function (Blueprint $table): void {
        ...
        $this->schema->create(
            'telescope_monitoring', static function (Blueprint $table): void {
                $table->string('tag');
            },
        );
    }
